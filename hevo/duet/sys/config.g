...
;M208 X283 Y295 Z285 S0                      ; Set axis maxima
...
;G31 P500 X30 Y0 Z2.04                   ; Set Z probe trigger value, offset and trigger height
...
;M106 P1 S0.75 I0 F500 H1 T45                ; Set fan 1 value, PWM signal inversion and frequency. Thermostatic control is turned on, 75%
...
;M557 X32:289 Y29:285 S32                     ; Define mesh grid
...
;
;M307 H1 A503.4 C229.4 D5.4 V24.1 B0
